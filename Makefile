...
CXX_Consumer       = -DSF_BUILD_CONSUMER
CXX_Unity          = -DSF_BUILD_UNITY -DSF_BUILD_CONSUMER
...
SCU := 1
CONSUMER := $(if $(findstring Consumer,$(C)),1,)
UNITY := $(if $(findstring Unity,$(C)),1,)
...
$(LIBDIR)/$(1)$(LIBSUFFIX): $$(patsubst %.mm,$(OBJDIR)/%.o,$$(patsubst %.cpp,$(OBJDIR)/%.o,$$(patsubst %.c,$(OBJDIR)/%.o,$$(GFX$(1)SRCS)))) $$(GFX$(1)ARDEPS)
	@mkdir -p $$(dir $$@)
	@rm -f $$@
	@echo "  ar     $$@"
	$$(CMD)$$(P_AR) $$(P_AR_OUTOPT)$$@ $$(patsubst %.mm,$(OBJDIR)/%.o,$$(patsubst %.cpp,$(OBJDIR)/%.o,$$(patsubst %.c,$(OBJDIR)/%.o,$$(GFX$(1)SRCS)))) $$(GFX$(1)ARDEPS)
	$$(CMD)$$(P_RANLIB) $$@
endef
...
$(LIBDIR)/$(1)$(LIBSUFFIX): $$(patsubst %.cpp,$(OBJDIR)/%.$(1).o,$$(GFX$(1)SRCS)) $$(GFX$(1)ARDEPS)
	...
	@rm -f $$@
	@echo "  ar     $$@"
	$$(CMD)$$(P_AR) $$(patsubst %.cpp,$(OBJDIR)/%.$(1).o,$$(GFX$(1)SRCS)) $$(GFX$(1)ARDEPS)
	$$(CMD)$$(P_RANLIB) $$@
endef
